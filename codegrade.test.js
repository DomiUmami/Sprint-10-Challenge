...
describe('Pizza App', () => {
  ...
  beforeEach(async () => {
    ...
    btn_all = screen.queryByTestId('filterBtnAll')
    btn_s = screen.queryByTestId('filterBtnS')
    btn_m = screen.queryByTestId('filterBtnM')
    btn_l = screen.queryByTestId('filterBtnL')
